...
module.exports = {
  ...
  execute: async (client, message, args, embed, author, channel, guild) => {
    ...
    message.channel.send((`**${member}** kullanıcısı başarıyla **${reason}** sebebiyle **${sure}** boyunca susturuldu! (Ceza Numarası: \`#${db.fetch(`ceza_${guild.id}`)}\`)`))
    ...
    db.push(`sicil_${member.id}`, `${author} tarafından __**${moment(Date.now()).format("LLL")}**__ tarihinde **${reason}** sebebiyle **MUTE** cezası almış.`)
